 ...
 */
export function getCOERequests(search, filter, page) {
  return {
    type: GET_COELIST,
    search,
    filter,
 ...
 */
export function getCOERequestsSuccess(data, pages) {
  return {
    type: GET_COELISTSUCCESS,
    data,
    pages,
  };
}
 ...
 */
export function getCOERequestsError(error) {
  return {
    type: GET_COELISTERROR,
    error,
  };
}

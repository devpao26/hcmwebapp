...
export class DTRComponent extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
    this.state = {
      searchVal: '',
    ...
    return (
      <ListContainer>
        ...
        <Modal
          ...
          showCloseBtn
          title="DTR Reconciliation Approval"
          width="500px"
        >
          {(requestDetails) &&
            <FormViewDetails>
              ...
              }
              {
                <p>
                  ...
                  <span className="value">{moment(requestDetails.CreatedDate).format('LL')}</span>
                </p>
              }
              {
                <p>
                  <span className="label">Shift Date</span>
                  <span className="value">{requestDetails.ShiftDate}</span>
                </p>
              }
              {
                <p>
                  <span className="label">DTR Active Minutes</span>
                  <span className="value">{requestDetails.DTRActiveMinutes}</span>
                </p>
              }
              {
                <p>
                  <span className="label">Requested Minutes</span>
                  <span className="value">{requestDetails.RequestedMinutes} mins</span>
                </p>
              }
              {/* {
                <p>

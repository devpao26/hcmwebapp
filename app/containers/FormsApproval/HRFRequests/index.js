...
export class HRFComponent extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
    this.state = {
      searchVal: '',
            ...
            <FormViewDetails>
              ...
              }
              {
                <p>
                  ...
                  <span className="value">{requestDetails.Title}</span>
                </p>
              }
              {
                <div>
                  <p className="half">
                    ...
                    <span className="value">{requestDetails.JobLvl.Name}</span>
                  </p>
                  <p className="half">
                    <span className="label">Employment Status</span>
                    <span className="value">{requestDetails.EmploymentStatus.Name}</span>
                  </p>
                </div>
              }
              {
                <p>
                  <span className="label">Job Description and Responsibilites</span>
                  <span className="value border">{requestDetails.Descr}</span>
                </p>
              }
              {
                <p>
                  <span className="label">Location</span>
                  <span className="value">{requestDetails.ComSiteLoc.Name}</span>
                </p>
              }
              {
                <p>
                  <span className="label">Required Skills</span>
                  <span className="value border">{requestDetails.JobSkillsReqsList.map((item) => <p>{item.Name}</p>)}</span>
                </p>
              }
              {
                <p>
                  <span className="label">Assesments</span>
                  <span className="value border">{requestDetails.JobSkillsReqsList.map((item) => <p>{item.Name}</p>)}</span>
                </p>
              }
              {
                <p>
                  <span className="label">Mimimum Salary</span>
                  <span className="value">{requestDetails.MinComp}</span>
                </p>
              }
              {
                <p>
                  <span className="label">Maximum Salary</span>
                  <span className="value">{requestDetails.MaxComp}</span>
                </p>
              }
...
const withReducer = injectReducer({ key: 'HRFRequests', reducer });
const withSaga = injectSaga({ key: 'HRFRequests', saga });

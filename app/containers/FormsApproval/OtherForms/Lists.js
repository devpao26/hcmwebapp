...
import { convertPastTense, parseDate } from 'components/Methods';

export class RequestListsComponent extends React.PureComponent {
      ...
      const listItem = lists.map((item, index) => {
        ...
        return (
          <Row className="body" statusDot twoSmall key={item.FormRequestID}>
            ...
            <div className="cell" data-title="Request Type">
              {item.WorkFlowForm.Name}
            </div>
...
RequestListsComponent.propTypes = {
...
export default RequestListsComponent;

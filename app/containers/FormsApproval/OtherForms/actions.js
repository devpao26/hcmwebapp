 ...
 * @return {object}         Returns an object with a type of GET_LIST
 */
 ...
 * @return {object}         Returns an object with a type of GET_LISTSUCCESS
 */
export function getListRequestsSuccess(data, pages) {
  return {
 ...
 * @return {object}         Returns an object with a type of GET_LISTERROR
 */
export function getListRequestsError(error) {
  return {
    type: GET_LISTERROR,
    error,
  };

        ...
        return (
          <Row className="body" statusDot twoSmall key={item.FormRequestID}>
            ...
            <div className="cell" data-title="Category">
              {(item.RTWOReason.Name) ? item.RTWOReason.Name : '-'}
            </div>
            <div className="cell" data-title="Activation Date">
              {moment(item.ActivationDate).format('MM-DD-YYYY')}
            </div>
      ...
      return (
        <div className="row-container">
          <Row className="head" statusDot>
            ...
            <div className="cell">Activation Date</div>

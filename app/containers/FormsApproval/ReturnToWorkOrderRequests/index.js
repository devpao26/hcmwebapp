...
import ReturnToWorkOrderLists from './Lists';

export class ReturnToWorkOrderRequestComponent extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
    this.state = {
      searchVal: '',
  ...
  render() {
    ...
    return (
      <ListContainer>
        <h3>Return To Work Order Requests List</h3>
        ...
        <Listings noPadding>
          <ReturnToWorkOrderLists {...refLists} />
        </Listings>
        ...
        <Modal
          ...
          showCloseBtn
          title="Return To Work Order Request Details"
          width="400px"
        >
          {(requestDetails) &&
            <FormViewDetails>
              ...
              <p>
                ...
                <span className="value">{requestDetails.RTWOReason.Name}</span>
              </p>
              <p>
                <span className="label">Note</span>
                <span className="value">{requestDetails.Reason}</span>
              </p>
              <p>
                <span className="label">Date</span>
                <span className="value">{moment(requestDetails.ActivationDate).format('MM-DD-YYYY')}</span>
              </p>
              <p>
                <span className="label">Time</span>
                <span className="value">{moment(requestDetails.ActivationDate).format('LT')}</span>
              </p>
              <p>
...
ReturnToWorkOrderRequestComponent.propTypes = {
...
const withReducer = injectReducer({ key: 'RTWORequests', reducer });
const withSaga = injectSaga({ key: 'RTWORequests', saga });

export default compose(
  withReducer,
  withSaga,
  withConnect,
)(ReturnToWorkOrderRequestComponent);

      ...
      const listItem = lists.map((item, index) => {
        ...
        return (
          <Row className="body" statusDot twoSmall key={item.FormRequestID}>
            ...
            <div className="cell" data-title="requested-shift-template-name">
              {(item.ShiftTemplate.Name) ? item.ShiftTemplate.Name : '-'}
            </div>
            <div className="cell" data-title="shift-date">
              {`${moment(item.RequestDateFrom).format('MM-DD-YYYY')} to ${moment(item.RequestDateTo).format('MM-DD-YYYY')}`}
            </div>
      ...
      return (
        <div className="row-container">
          <Row className="head" statusDot>
            ...
            <div className="cell">Requested Shift Schedule Template</div>
            <div className="cell">Requested Shift Schedule Date</div>

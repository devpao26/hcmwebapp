 ...
 */
export function* getIRFRequestList() {
  ...
  const requestURL = API_SHIFTREQUESTLIST;
  ...
  try {
    ...
    const resp = apirequest.GetShiftScheduleRequestListingsResult[0];
...
export default function* rootSagas() {
  ...
  // actions
  yield takeLatest(GET_LIST, getIRFRequestList);

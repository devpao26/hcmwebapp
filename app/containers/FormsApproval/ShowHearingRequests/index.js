...
export class ShowHearingRequestComponent extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
    this.state = {
      searchVal: '',
          ...
          {(requestDetails) &&
            <div className="section-half">
              <FormViewDetails>
                ...
                <p>
                  <span className="label">Employee Under Investigation</span>
                ...
                <div>
                  <p className="half">
                    ...
                    <span className="value">{moment(requestDetails.FormRequest.HearingDate).format('LL')}</span>
                  </p>
                  <p className="half">
                    <span className="label">Time</span>
                    <span className="value">{moment(requestDetails.FormRequest.HearingDate).format('h:mm A')}</span>
                  </p>
                </div>
                <p>
                  <span className="label">Location</span>
                  <span className="value">{requestDetails.HearingLoc.Name}</span>
                </p>
                <p>
                  <span className="label">Show Cause Memo</span>
                  <span className="value">{requestDetails.SCMRequest.FormRequest.EmpProfile.LastName}, {requestDetails.SCMRequest.FormRequest.EmpProfile.FirstName}</span>
                  <span className="value">Incident Date: {moment(requestDetails.SCMRequest.FormRequest.IncidentDate).format('YYYY-MM-DD')}</span>
                  <span className="value">Possible Rule Violation: {requestDetails.SCMRequest.RuleViolation.Name}</span>
                </p>
                <p>
                  <span className="label">Violation</span>
                  <span className="value border">{requestDetails.Violation}</span>
                </p>
              ...
              <FormViewDetails>
                <p>
                  <span className="label">Committee Members</span><br />
                  <span className="value">{requestDetails.HearingRequestCommitteeList.map((item) => <p>{item.EmpProfile.LastName}, {item.EmpProfile.FirstName}</p>)}</span>
                </p>
              </FormViewDetails>
            </div>
          }
...
ShowHearingRequestComponent.propTypes = {
...
const withReducer = injectReducer({ key: 'ShowHearingFormRequests', reducer });
const withSaga = injectSaga({ key: 'ShowHearingFormRequests', saga });

export default compose(
  withReducer,
  withSaga,
  withConnect,
)(ShowHearingRequestComponent);

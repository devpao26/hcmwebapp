 ...
 */
export function* getShowHearingRequests() {
  ...
  const requestURL = API_SHREQUESTLIST;
  ...
  try {
    ...
    const resp = apirequest.GetHearingRequestListingsResult[0];
...
export default function* rootSagas() {
  ...
  // actions
  yield takeLatest(GET_LIST, getShowHearingRequests);

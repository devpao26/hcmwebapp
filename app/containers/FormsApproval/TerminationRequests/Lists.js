      ...
      const listItem = lists.map((item, index) => {
        ...
        return (
          <Row className="body" statusDot twoSmall key={item.FormRequestID}>
            ...
            <div className="cell" data-title="employee-for-termination">
              {`${item.FormRequest.EmpProfile.LastName}, ${item.FormRequest.EmpProfile.FirstName}`}
            </div>
      ...
      return (
        <div className="row-container">
          <Row className="head" statusDot>
            ...
            <div className="cell">Employee for Termination</div>

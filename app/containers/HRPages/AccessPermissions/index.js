...
class AdminAccessPermissions extends React.PureComponent {
  render() {
    return (
      <PageWrap>
        <Helmet>
          <title>HR Administration | Access and Permissions</title>
          <meta name="description" content="HCM-EMP - HR Administration | Access and Permissions" />
        </Helmet>
        <Header />
        ...
        <Main>
          <PageContent>
            ...
            <AccessPermissions isGenAdmin={false} adminRequester="HR" />
          </PageContent>
        </Main>
        <Footer />
      </PageWrap>

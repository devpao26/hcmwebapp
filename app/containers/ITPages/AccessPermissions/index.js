...
class AdminAccessPermissions extends React.PureComponent {
  render() {
    return (
      <PageWrap>
        <Helmet>
          <title>IT Administration | Access and Permissions</title>
          <meta name="description" content="HCM-EMP - IT Administration | Access and Permissions" />
        </Helmet>
        <Header />
        ...
        <Main>
          <PageContent>
            ...
            <AccessPermissions isGenAdmin={false} adminRequester="IT" />
          </PageContent>
        </Main>
        <Footer />
      </PageWrap>

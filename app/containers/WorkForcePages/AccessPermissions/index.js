...
class AdminAccessPermissions extends React.PureComponent {
  render() {
    return (
      <PageWrap>
        <Helmet>
          <title>WorkForce Administration | Access and Permissions</title>
          <meta name="description" content="HCM-EMP - WorkForce Administration | Access and Permissions" />
        </Helmet>
        <Header />
        ...
        <Main>
          <PageContent>
            ...
            <AccessPermissions isGenAdmin={false} adminRequester="WF" />
          </PageContent>
        </Main>
        <Footer />
      </PageWrap>

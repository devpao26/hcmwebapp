...
class CreateNewTemplateForm extends React.PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      templateDescr: this.props.details.Descr,
      templateDescrError: false,
      templateFieldsError: false,
      // isMeeting: this.props.details.WithMeeting,
    };
  }
    ...
    return (
      <CreateNewForm>
        ...
        <Fields>
          ...
          <input id="createTempName" type="text" defaultValue={this.state.templateName} placeholder="New Work Status Template Name" onChange={this.templateName} className={this.state.templateNameError && 'error'} />
        </Fields>
        <Fields>
          <label htmlFor="createTempDesc">Description</label>
          <input id="createTempDesc" type="text" defaultValue={this.state.templateDescr} placeholder="Template Description Here" onChange={this.templateDescr} className={this.state.templateDescrError && 'error'} />
        </Fields>
        {/* <Fields>
